...
"""
    ...
    def daily_memory_check(self, days_back: int = 1) -> dict:
        """
        ...
        Returns:
        {
            ...
            'memory': {...},
            'question': 'Do you remember who this is?'
        }
        """
        ...
        return {
            'greeting': 'Good morning! Here is something from yesterday.',
            'has_memories': True,
            'memory': memory,
            'question': f"Do you remember who this is?",
            'hint_available': True
        }
    
    def help_remember(self, memory_id: str) -> str:
        """
        When patient clicks "Help me" button
        Explains the memory gently
        """
        ...
        # Generate gentle explanation
        prompt = f"""Explain this memory to an Alzheimer's patient in the kindest, simplest way:

Person: {memory['person']}
Event: {memory['event']}
What happened: {memory['summary_text']}

Speak directly to them, warmly. Start with "This is..."
"""
